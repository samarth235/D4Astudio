...
<header class="header">
  <div class="header-container">
    ...
    <a href="/"><img src="img.jpeg" class="logo" /></a>

    <nav class="nav">
      <a href="/"><div class="slot"><span>Home<br />Home</span></div></a>
      <a href="/#gallery"><div class="slot"><span>Projects<br />Projects</span></div></a>
      <a href="/#approach"><div class="slot"><span>Our Approach<br />Our Approach</span></div></a>
      <a href="/about.html" aria-current="page"><div class="slot"><span>About Us<br />About Us</span></div></a>
    </nav>

    <!-- NEW HAMBURGER (same as homepage) -->
